...
import static com.meawallet.sdkregistry.out.transaction.TransactionTestData.getTestSdk;
...
@MockitoSettings
class TransactionRegistrationOutServiceTest {
    ...
    TransactionServiceProperties props = new TransactionServiceProperties(registrationUrl, timeout);

    TransactionRegistrationOutService victim;
    ...
    void setUp() {
        var webClient = WebClient.builder()
                                 .exchangeFunction(exchangeFunction)
                                 .build();
        victim = new TransactionRegistrationOutService(props, webClient);
    }
    ...
    void shouldFailAny4xxResponse() {
        ...
        var sdk = getTestSdk();
        StepVerifier.create(victim.register(sdk))
                    .expectErrorSatisfies(t -> assertThat(t).hasMessageContaining("Registration failed in Transaction Service"))
                    .verify();
    }
    ...
    void shouldFailByTimeout() {
        ...
        StepVerifier.withVirtualTime(() -> victim.register(sdk))
                    ...
                    .expectErrorSatisfies(t -> assertThat(t).hasMessageContaining("Registration failed in Transaction Service by timeout"))
                    .verify();
    }
}
