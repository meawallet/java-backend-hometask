...
import static com.meawallet.sdkregistry.out.attestation.AttestationTestData.getTestSdk;
...
@MockitoSettings
class AttestationRegistrationOutServiceTest {
    ...
    String registrationUrl = "www.meawallet.com/attestation/registration";
    Duration timeout = Duration.ofSeconds(2);
    AttestationServiceProperties props = new AttestationServiceProperties(registrationUrl, timeout);

    AttestationRegistrationOutService victim;
    ...
    void setUp() {
        var webClient = WebClient.builder()
                                 .exchangeFunction(exchangeFunction)
                                 .build();
        victim = new AttestationRegistrationOutService(props, webClient);
    }
    ...
    void shouldFailAny4xxResponse() {
        ...
        var sdk = getTestSdk();
        StepVerifier.create(victim.register(sdk))
                    .expectErrorSatisfies(t -> assertThat(t).hasMessageContaining("Registration failed in Attestation Service"))
                    .verify();
    }
    ...
    void shouldFailByTimeout() {
        ...
        StepVerifier.withVirtualTime(() -> victim.register(sdk))
                    ...
                    .expectErrorSatisfies(t -> assertThat(t).hasMessageContaining("Registration failed in Attestation Service by timeout"))
                    .verify();
