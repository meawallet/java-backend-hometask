...
public class DbUnitConfig {
    ...
    @Bean
    public DataSource dbUnitDataSource(@Value("${spring.dbunit.datasource.url}") String url,
                                       @Value("${spring.dbunit.datasource.username}") String username,
                                       @Value("${spring.dbunit.datasource.password}") String password,
                                       @Value("${spring.dbunit.datasource.driver}") String driver) {
